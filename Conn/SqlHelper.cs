...
namespace Conn
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionStringLocal = ConfigurationManager.AppSettings["SqlConnectionStr"];
        ...
        public static int ExecuteNonQueryVal(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
